package com.example.application.views.formjava;
...
@Route(value = "form-java")
@PageTitle("Form (Java)")
@CssImport("views/formjava/form-java-view.css")
public class FormJavaView extends Div {
